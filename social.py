...
class Social:
    def  __init__(self,root):
        ...
        self.root.title("Social Distancing")



        
        #bgimg
        img4=Image.open(r"Imges\SD.PNG")
        ...
        title_lbl=Label(bg_img,text="Social Distance Detection",font=("times new roman",35,"bold"),bg="blue",fg="white")
        title_lbl.place(x=0,y=0,width=1530,height=65)


        #Button Social Disatancing
        img6=Image.open(r"Imges\SD-bt.PNG")
        ...
        b1_1=Button(bg_img,text="Detect Social Distancing",command=detect_socialq,cursor="hand2",font=("times new roman",15,"bold"),bg="green",fg="white")
