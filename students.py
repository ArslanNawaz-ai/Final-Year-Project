...
class Student:
    def  __init__(self,root):
        ...
        #bgimg
        img4=Image.open(r"Imges\St3.PNG")
        ...
        title_lbl=Label(bg_img,text="Student Mangement",font=("times new roman",35,"bold"),bg="blue",fg="white")
        title_lbl.place(x=0,y=0,width=1530,height=65)

        main_frame=Frame(bg_img,bd=2)
        main_frame.place(x=70,y=120,width=1400,height=650)

        #left label frame

        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=710,height=630)


        
        #student img
        img_left=Image.open(r"Imges\girl.jpeg")
        img_left=img_left.resize((715,580),Image.ANTIALIAS)
        self.photoimg_left=ImageTk.PhotoImage(img_left)

        f_lbl=Label(self.root,image=self.photoimg_left)
        f_lbl.place(x=85,y=160,width=705,height=110)


        #Current course information

        current_course_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Current Course Information",font=("times new roman",12,"bold"))
        current_course_frame.place(x=4,y=115,width=700,height=150)
        ...
        dep_combo["values"]=("Select Department","COE","COCIS","COMS","COA")
        dep_combo.current(0) 
        ...
        course_combo["values"]=("Select Course","PF","IICT","VLM","PIS","M1","M2","Stats","E1","E2","E3","POM","FA","DM","AI","DCN","OOP","OOAD","DBMS","SE","FYP")
        ...
        year_combo["values"]=("Select Year","2015","2016","2017","2018","2019","2020","2021")
        ...
        semester_combo["values"]=("Select Semester","Semester 1","Semester 2","Semester Summer")
        semester_combo.current(0) 
        semester_combo.grid(row=1,column=3,padx=2,pady=10,sticky=W)

        #Class student iformation

        class_student_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Class Student Information",font=("times new roman",12,"bold"))
        class_student_frame.place(x=4,y=220,width=700,height=380)
        ...
        btn_frame1.place(x=0,y=290,width=700,height=40)
        ...
        Right_frame.place(x=730,y=10,width=660,height=630)
        ...
        #student img
        img_right=Image.open(r"Imges\university.jpg")
        img_right=img_right.resize((715,580),Image.ANTIALIAS)
        ...
        search_label=Label(Search_frame,text="Search By:",font=("times new roman",12,"bold"),bg="brown")
        search_label.grid(row=0,column=0,padx=10,sticky=W)

        #search
        self.var_combo_search=StringVar()
        search_combo=ttk.Combobox(Search_frame,textvariable=self.var_combo_search,font=("times new roman",12,"bold"),state="readonly",width=15)

        search_combo["values"]=("Select","Roll","Phone","Email","student_id")
        ...
        self.student_table=ttk.Treeview(table_frame,column=("dep","course","year","sem","id","name","div","roll","gender","dob","email","address","phone","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.student_table.heading("photo",text="PhotoStampleStatus")
...
#=================function declartion=====================================
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            messagebox.showerror("Error","All fields are not filled",parent=self.root)
        else:
            try:
...
#===================get cursor===============
    ...
    def update_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                Updat=messagebox.askyesno("Update","Do you want to update this student details",parent=self.root)
                if Updat>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="Test@123",database="facerecognition")
                    my_cursor=conn.cursor()
